...
inTable = r"C:\Users\b35143921880\Downloads\ConcurrentGeocode\Geocode_cadunico\cadunico.gdb\cadunico_familia_2019_input_geocode"
inLocator = r"C:\StreetMap\NewLocators\BRA\BRA.loc"
procCount =  8
scratchDir = r"C:\Users\b35143921880\Downloads\scratch"
workerScript = r"C:\Users\b35143921880\Downloads\ConcurrentGeocode\Geocode_cadunico\Worker.py"
outFC = r"C:\Users\b35143921880\Documents\ArcGIS\Projects\MyProject4\MyProject4.gdb\cadunico_familia_2019_geocoded"
...
fInfo = "'Address or Place' logradouro VISIBLE NONE;Address2 <None> VISIBLE NONE;Address3 <None> VISIBLE NONE;Neighborhood bairro VISIBLE NONE;City name_muni VISIBLE NONE;County <None> VISIBLE NONE;State abbrev_state VISIBLE NONE;ZIP nu_cep_logradouro_fam VISIBLE NONE;ZIP4 <None> VISIBLE NONE;Country <None> VISIBLE NONE"
fList = ['OID@','logradouro','name_muni','abbrev_state','bairro','nu_cep_logradouro_fam','cd_ibge_cadastro','co_familiar_fam', 'ano'] # include any other fields desired
