...
inTable = r"C:\Users\b35143921880\Downloads\ConcurrentGeocode\CNES.gdb\cnes_2019_input_geococde_streetmap"
inLocator = r"C:\StreetMap\NewLocators\BRA\BRA.loc"
procCount =  8
scratchDir = r"C:\Users\b35143921880\Downloads\scratch"
workerScript = r"C:\Users\b35143921880\Downloads\ConcurrentGeocode\Worker.py"
outFC = r"C:\Users\b35143921880\Documents\ArcGIS\Projects\MyProject4\MyProject4.gdb\CNES_2019_Geocode_StreetMap"
...
fInfo = "'Address or Place' logradouro VISIBLE NONE;Address2 <None> VISIBLE NONE;Address3 <None> VISIBLE NONE;Neighborhood bairro VISIBLE NONE;City municipio VISIBLE NONE;County <None> VISIBLE NONE;State uf VISIBLE NONE;ZIP cep VISIBLE NONE;ZIP4 <None> VISIBLE NONE;Country <None> VISIBLE NONE"
fList = ['OID@','logradouro','bairro','municipio','uf','cep', 'cnes', 'year_input'] # include any other fields desired
