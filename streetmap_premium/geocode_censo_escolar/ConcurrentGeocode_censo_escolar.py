...
inTable = r"C:\Users\b35143921880\Downloads\ConcurrentGeocode\Geocode_Censo_escolar\Censo_escolar.gdb\escolas_input_geocode"
inLocator = r"C:\StreetMap\NewLocators\BRA\BRA.loc"
procCount =  8
scratchDir = r"C:\Users\b35143921880\Downloads\scratch"
workerScript = r"C:\Users\b35143921880\Downloads\ConcurrentGeocode\Geocode_Censo_escolar\Worker.py"
outFC = r"C:\Users\b35143921880\Documents\ArcGIS\Projects\MyProject4\MyProject4.gdb\escolas_output_geocode_com_bairro"
...
fInfo = "'Address or Place' logradouro VISIBLE NONE;Address2 <None> VISIBLE NONE;Address3 <None> VISIBLE NONE;Neighborhood bairro VISIBLE NONE;City cidade VISIBLE NONE;County <None> VISIBLE NONE;State uf VISIBLE NONE;ZIP cep VISIBLE NONE;ZIP4 <None> VISIBLE NONE;Country <None> VISIBLE NONE"
fList = ['OID@','logradouro','cidade','uf','cep','co_entidade','endereco','lon','lat','bairro'] # include any other fields desired
